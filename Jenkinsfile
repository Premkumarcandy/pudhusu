    ...
    stages {
        ...
        stage("DeploytoGKE") {
            steps {
                ...
                step([$class: 'KubernetesEngineBuilder', projectId: "red-delight-223804", clusterName: "cision", location: "us-central1-a", manifestPattern: 'deployment.yml', credentialsId: "jenkins-sa", verifyDeployments: true])
            }
        }
    }
}
